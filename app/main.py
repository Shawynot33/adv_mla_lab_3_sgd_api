...
# load trained model and save into a variable called sgd_pipe
sgd_pipe = load('models/sgd_pipeline.joblib')

# create function read_root()
@app.get("/")
def read_root():
    return {"Hello": "World"}


# create function healthcheck() that will return SGDClassifier is all read to go!
